                            ...
                            <form method="GET" action="{{ route('player.history', $player->_id) }}">
                                <div class="d-flex justify-content-end gap-2 mb-3">
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="from_date" id="from_date" class="form-control mb-0" value="{{ request('from_date') }}">
                                    </div>

                                    <div>
                                        <label for="to_date" class="form-label mb-0">To Date</label>
                                        <input type="date" name="to_date" id="to_date" class="form-control mb-0" value="{{ request('to_date') }}">
                                    </div>
                                ...
                                <div class="d-flex justify-content-center mt-3 gap-2">
                                    <a href="{{ route('export.game.history', $player->_id) }}" class="btn btn-sm btn-primary">
