                                ...
                                <form role="form text-left" action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" class="form-control" placeholder="First Name"
                                            aria-label="firstName" name="firstName" value="{{ old('firstName') }}"
                                            aria-describedby="email-addon" required>
                                    </div>
                                    <div class="mb-3">
                                        <input type="text" class="form-control" placeholder="Last Name"
                                            aria-label="lastName" name="lastName" value="{{ old('lastName') }}"
                                            aria-describedby="email-addon" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <p class="text-sm mt-3 mb-0">Already have an account?
                                        <a href="{{ route('show.login') }}" class="text-dark font-weight-bolder">Sign
                                            in</a>
                                    </p>
                                </form>
                            </div>
