...
Route::get('/login-history', [PagesController::class, 'loginHistory'])->name('login.history')->middleware('auth:web,admin');
...
Route::post('/settings/update-big-player', [PagesController::class, 'updateBigPlayer'])->name('settings.updateBigPlayer');
